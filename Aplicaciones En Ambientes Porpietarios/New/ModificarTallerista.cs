...
namespace Aplicaciones_En_Ambientes_Porpietarios
{
    public partial class ModificarTallerista : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = bd.SelectDataTable("EXEC dbo.BuscarPersonaTallerista");
        }
        ...
        private void buscar()
        {
            ...
            {
                string consultar = "EXEC dbo.BuscarPersonaTalleristaCI @CI  ='" + textBox1.Text + "'";
                dataGridView1.DataSource = bd.SelectDataTable(consultar);
            }
            else if (comboBox3.Text.Equals("RUC"))
            {
                string consultar = "EXEC dbo.BuscarPersonaTalleristaRUC @RUC ='" + textBox1.Text + "'";
                dataGridView1.DataSource = bd.SelectDataTable(consultar);
            }
            else if (comboBox3.Text.Equals("Nombre"))
            {
                string consultar = "EXEC dbo.BuscarPersonaTalleristaNombre @nombreP ='" + textBox1.Text + "'";
                dataGridView1.DataSource = bd.SelectDataTable(consultar);
            }
            else if (comboBox3.Text.Equals("Apellido"))
            {
                string consultar = "EXEC dbo.BuscarPersonaTalleristaApellido @apellidoP ='" + textBox1.Text + "'";
                dataGridView1.DataSource = bd.SelectDataTable(consultar);
            }
        ...
        private void consulta1()
        {
            ...
            string actualizarProfesor = "EXEC dbo.ActualizarPersonaTalleristaCI @CI = '" + txtIdentificacion.Text + "', @RUC = null," +
        ...
        private void consulta2()
        {
            ...
            string[] sueldo = pago.Split(',');
            string salario = sueldo[0] + "." + sueldo[1];
            string actualizarProfesor = "EXEC dbo.ActualizarPersonaTalleristaRUC @CI = null, @RUC = '" + txtIdentificacion.Text + "'," +
                " @nombreP = '" + txtNombre.Text + "', @apellidoP = '" + txtApellidos.Text + "', " +
                "@direccionP = '" + txtDireccion.Text + "', @fechaNaciP = '" + dateTimePicker1.Text + "', " +
                "@telefonoP = '" + txtTelefono.Text + "', @emailP = '" + txtEmail.Text + "'," +
                " @observacionP = null, @cobreI = '" + salario + "'";
