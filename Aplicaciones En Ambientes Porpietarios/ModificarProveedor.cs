...
namespace Aplicaciones_En_Ambientes_Porpietarios
{
    public partial class ModificarProveedor : Form
    {
        ...
        private void pictureBox5_Click(object sender, EventArgs e)
        {
            ...
            //dataGridView1.DataSource = bd.SelectDataTable("exec dbo.BuscarPersonaTurista");
        }
        ...
        private void buscar()
        {
            ...
            {
                string consultar = "EXEC dbo.BuscarPersonaTuristaCI @CI  ='" + textBox1.Text + "'";
                dataGridView1.DataSource = bd.SelectDataTable(consultar);
            }
            else if (comboBox3.Text.Equals("RUC"))
            {
                string consultar = "EXEC dbo.BuscarPersonaTuristaRUC @RUC ='" + textBox1.Text + "'";
                dataGridView1.DataSource = bd.SelectDataTable(consultar);
            }
            else if (comboBox3.Text.Equals("Nombre"))
            {
                string consultar = "EXEC dbo.BuscarPersonaTuristaNombre @nombreP ='" + textBox1.Text + "'";
                dataGridView1.DataSource = bd.SelectDataTable(consultar);
            }
            else if (comboBox3.Text.Equals("Apellido"))
            {
                string consultar = "EXEC dbo.BuscarPersonaTuristaApellido @apellidoP ='" + textBox1.Text + "'";
                dataGridView1.DataSource = bd.SelectDataTable(consultar);
            }
        ...
        private void consulta1()
        {
            ...
            string actualizarInstructor = "exec p_turistaModificar " +
        ...
        {
            string name = bd.selectstring("select (replace(NOMBRE,' ', '')) as NOMBRES from RECORRIDO WHERE CODRECORRIDO =" + profe + "");
            return name;
        }
